...
def random_displacement(
   source_depth_range=(2e3, 10e3),
    dip_angle_range=(70, 90),
    strike_angle_range=(0, 360),
    strike_width_range=(10e3, 30e3),
    dip_width_range=(4000, 10000),
    rake_angle_range=(0, 0.1),  # dip slip
    slip_magnitude_range=(0.025, 0.1),
    alpha=0.66,
    resolution=180,
    shape=(48, 48),
    seed=None,
